<template>
  <RouterLink :to class="h-[var(--g-sidebar-logo-height)] w-inherit flex-center gap-2 px-3 text-primary no-underline" :class="{ 'cursor-default': !settingsStore.settings.home.enable }" :title="title">
