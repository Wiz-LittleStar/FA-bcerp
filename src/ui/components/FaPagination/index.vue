<template>
  <Pagination v-slot="{ page: currentPage }" :total="props.total" :sibling-count="1" show-edges :page="props.page" :items-per-page="props.size" @update:page="(val) => emits('pageChange', val)">
